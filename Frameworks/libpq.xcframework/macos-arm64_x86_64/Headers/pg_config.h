...
#define CONFIGURE_ARGS " '--with-icu' '--prefix=/Users/illiasenchukov/Desktop/projects/postgresql-17.0/build-arm64/../install-arm64' '--host=arm-apple-darwin' 'ICU_CFLAGS=-I/opt/homebrew/opt/icu4c/include' 'ICU_LIBS=-L/opt/homebrew/opt/icu4c/lib -licui18n -licuuc -licudata' 'CXXFLAGS=std=c++20' 'host_alias=arm-apple-darwin'"
...
#define PG_VERSION_STR "PostgreSQL 17.0 on arm-apple-darwin, compiled by Apple clang version 16.0.0 (clang-1600.0.26.4), 64-bit"
