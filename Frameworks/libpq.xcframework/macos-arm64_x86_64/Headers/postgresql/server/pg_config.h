...
#define CONFIGURE_ARGS " '--without-icu' '--prefix=/Users/illiasenchukov/Desktop/projects/querynaut-dependencies/libs/libpq/arm64' 'CFLAGS=-mmacosx-version-min=14.6' 'CXXFLAGS=-mmacosx-version-min=14.6'"
...
#define PG_VERSION_STR "PostgreSQL 17.5 on aarch64-apple-darwin24.5.0, compiled by Apple clang version 17.0.0 (clang-1700.0.13.3), 64-bit"
